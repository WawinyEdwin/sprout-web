...
import { Send, Brain, Users, TrendingUp, AlertTriangle, Target, BarChart3 } from "lucide-react"
...
export default function ChatPage() {
  ...
  const getAIResponse = (question: string): string => {
    ...
    if (lowerQuestion.includes("revenue") && lowerQuestion.includes("forecast")) {
    ...
    if (lowerQuestion.includes("campaigns") && lowerQuestion.includes("pause")) {
    ...
    if (lowerQuestion.includes("conversion") && lowerQuestion.includes("drop")) {
      return [
        ...
        },
        {
          ...
          description: "If unresolved, this will cost $12,400 in lost revenue over the next 7 days.",
          confidence: 89,
          impact: "High",
        },
        {
          ...
          description: "Fix payment gateway timeout, A/B test simplified checkout, monitor mobile performance.",
          actions: ["Fix payment timeout", "Deploy simplified checkout", "Set up mobile monitoring"],
        },
      ]
    }
    ...
    if (lowerQuestion.includes("revenue") && lowerQuestion.includes("forecast")) {
      return [
        ...
        },
        {
          ...
          description: "Increase email marketing budget by 40% to capture additional $3,200 in revenue.",
          actions: ["Increase email budget", "Launch holiday campaign", "Optimize product pages"],
        },
      ]
    }
    ...
    return [
      {
        ...
        description: "Your business is performing well with 3 optimization opportunities identified.",
        confidence: 92,
      },
    ]
  }
        ...
        <div className="max-w-5xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-600 text-lg">
              Ask questions, get predictions, understand root causes, and receive automated recommendations.
            </p>
          </div>
          ...
          <div className="mb-8 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl border border-emerald-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-emerald-900">AI Brain Status: Actively Learning</h3>
                  <p className="text-sm text-emerald-700">
                    Monitoring 47 KPIs • 3 predictions ready • 2 actions pending approval
                  </p>
                </div>
              </div>
          ...
          <Card className="h-[700px] flex flex-col border-0 shadow-2xl bg-gradient-to-br from-white to-slate-50">
            <CardHeader className="border-b bg-gradient-to-r from-slate-50 to-white">
              <CardTitle className="flex items-center gap-3">
                <Brain className="w-6 h-6 text-emerald-600" />
                AI Business Brain Chat
                <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100">Predictive Mode</Badge>
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="flex-1 flex flex-col p-0">
                  ...
                  {messages.map((message) => (
                    ...
                    >
                      <div className={`max-w-[85%] ${message.type === "user" ? "order-2" : "order-1"}`}>
                          ...
                          <div
                            className={`rounded-2xl p-6 ${
                              message.type === "user"
                                ...
                                : "bg-gradient-to-br from-slate-50 to-white border border-slate-200 text-slate-900"
                            }`}
                          >
                            ...
                            {message.suggestions && (
                              <div className="mt-6 space-y-3">
                                <p className="text-xs font-medium opacity-75">Try asking:</p>
                                <div className="flex flex-wrap gap-2">
                        ...
                        <p
                          className={`text-xs text-slate-500 mt-2 ${message.type === "user" ? "text-right" : "text-left"}`}
                        >
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-2xl p-6">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-slate-600">AI Brain analyzing your data...</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="border-t bg-gradient-to-r from-slate-50 to-white p-6">
                <div className="flex gap-3 mb-4">
                  ...
                  <Button
                    ...
                    className="h-12 px-6 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 shadow-lg"
                  >
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge
                    ...
                    onClick={() => handleSuggestionClick("Predict next month's revenue")}
                  >
                  ...
                  <Badge
                    ...
                    onClick={() => handleSuggestionClick("Why are my costs increasing?")}
                  >
                  ...
                  <Badge
                    ...
                    onClick={() => handleSuggestionClick("Which campaigns should I optimize?")}
                  >
                  ...
                  <Badge
                    ...
                    onClick={() => handleSuggestionClick("Show me churn risk analysis")}
                  >
